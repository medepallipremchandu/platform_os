...
/**
 * Debounced text search box with a leading search icon, shared by every list page (Providers,
 * Call Agents, Calls) instead of each one wiring up its own input + timer. The parent owns the
 * actual filter/query state - this component only debounces keystrokes before calling `onChange`.
 */
