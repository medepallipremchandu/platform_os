 ...
 * iam-console/agent-builder-console's own posture. */
const ACCESS_TOKEN_KEY = "voiceagent.access_token";
const REFRESH_TOKEN_KEY = "voiceagent.refresh_token";
...
/** Reads a post-login token handoff out of the URL fragment (set by the portal app after a
...
/** Sends the browser to the portal app to log in, carrying the current URL as `return_to` so the
