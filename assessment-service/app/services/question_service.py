...
async def generate_questions(
    db: Session, skill: Skill, num_questions: int, llm_client: LLMClient, question_type: str = "descriptive"
) -> list[Question]:
    ...
    rubric_payload = [
        {"name": r.name, "description": r.description, "weight_percentage": float(r.weight_percentage)}
    ...
    generation: LLMQuestionGeneration = await llm_client.get_json(
        system_prompt, user_prompt, LLMQuestionGeneration
    )
