...
from app.services import file_parsing_service
...
async def analyze_resume(
    db: Session, filename: str, file_bytes: bytes, llm_client: LLMClient, actor: str
) -> ResumeAnalysis:
    ...
    extraction: LLMResumeExtraction = await llm_client.get_json(system_prompt, user_prompt, LLMResumeExtraction)
